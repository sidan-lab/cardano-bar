...
import { TSCodeBuilder } from "../codeBuilder/ts";

/**
 * TypeScript-specific blueprint parser
 * Handles all TypeScript code generation logic independently
 */
export class TypeScriptBlueprintParser {
  ...
  private codeBuilder: TSCodeBuilder;
  ...
  constructor(
    ...
    this.codeBuilder = new TSCodeBuilder();
  }
  ...
  private handleConstructor = (constr: Definition, currentTitle: string) => {
    ...
    // TypeScript uses simple constructor titles for variant names
